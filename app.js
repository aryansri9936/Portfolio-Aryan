...
function createParticle(container) {
    ...
    particle.style.cssText = `
        ...
        width: ${size}px;
        height: ${size}px;
        background: radial-gradient(circle, rgba(6, 182, 212, ${opacity}), transparent);
        border-radius: 50%;
...
function animateParticle(particle) {
    ...
    document.querySelector('#particle-animations').textContent += keyframes;
}
...
function addMouseTrackingEffect() {
    ...
    document.addEventListener('mousemove', (e) => {
        ...
        // Move cosmic rings based on mouse position
...
window.addEventListener('load', () => {
    ...
    // Add constellation effect to background
...
function createConstellationEffect() {
    ...
    for (let i = 0; i < constellationCount; i++) {
        ...
        `;
        hero.appendChild(constellation);
    }
